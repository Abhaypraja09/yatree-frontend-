                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
                            ...
                            <div>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
                                    ...
                                    <span style={{ fontSize: 'clamp(9px,2.5vw,10px)', fontWeight: '800', color: 'rgba(255,255,255,0.5)', letterSpacing: '1px', textTransform: 'uppercase' }}>Internal Asset Operations</span>
                                </div>
                                <h1 style={{ color: 'white', fontSize: 'clamp(24px, 5vw, 32px)', fontWeight: '900', margin: 0, letterSpacing: '-1.5px', cursor: 'pointer' }}>
                                    Staff <span className="text-gradient-yellow">Management</span>
                                </h1>
                            </div>
                        </div>
                    </div>
